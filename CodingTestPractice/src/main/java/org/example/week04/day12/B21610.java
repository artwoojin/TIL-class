...
public class B21610 {
    /*
    ***** 문제 설명 : 마법사 상어는 비바라기 마법을 크기가 N×N인 격자에서 연습하려고 한다.
    ...
    *     1번 행과 N번 행은 이어져있고, 1번 열과 N번 열도 이어져있다.
    ...
    *     1부터 순서대로 ←, ↖, ↑, ↗, →, ↘, ↓, ↙ 이고, 이동을 명령하면 다음 순서대로 진행된다.
    *
    ...
    *
    ***** 입출력 : 첫째 줄에 N, M이 입력되고 둘째 줄~N개의 줄에는 N개의 정수가 입력된다.
    *     r번째 행의 c번째 정수는 A[r][c]를 의미한다.
    *     다음 M개의 줄에는 이동의 정보 di, si가 순서대로 한 줄에 하나씩 주어진다.
    *     이 때 첫째 줄에 M번의 이동이 모두 끝난 후 바구니에 들어있는 물의 양의 합을 출력한다.
    *
    ***** 풀이 설계 :
     * */
