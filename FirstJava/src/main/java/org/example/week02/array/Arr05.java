package org.example.week02.array;
...
public class Arr05 {
    public static void main(String[] args) {
        ...
        // 2. 기본형 변수는 값 자체를 저장함, 참조형 변수는 별도의 공간에 값을 저장 후 그 주소를 저장함(=주소형 변수)

        // char < String(훨씬 더 많이 쓰임!)
        // String이 가지고 있는 기능이 너무 많아서임
        // Wrapper class와도 상당히 비슷함 -> 기본형 변수가 가지고 있는 기능이 제한됨
        // -> 다양한 기능을 제공하는 Wrapper를 감쌈으로서 추가기능을 더함
